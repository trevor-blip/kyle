...
<div class="main-content">
	<div class="wrapper">
		...
		<br>
		<?php  
		if(isset($_SESSION['update-meat']))
				{
					echo $_SESSION['update-meat'];// Displaying session message
					unset($_SESSION['update-meat']);//Removing session message
				}	
		...
		if(isset($_GET['id']))
		{
			...
			$sql="SELECT * FROM tbl_meat WHERE id=$id";
			//Execute the query
			...
			}else
			{
				...
				$_SESSION['no-meat']="<div class='error'>Meat Not Found</div>";
				//Redirect to manage meat page
				header("location:".SITEURL.'admin/manage.meat.php');
			...
			<table class="tbl-30">
				...
				<tr>
					...
					<td>
						...
						if($current_image!="")
						{
							//Display the image
							?>
							<img src="<?php echo SITEURL;?>images/meat/<?php echo $current_image;?>" width="150px">
							<?php
						}else
						{
							//Send error message
				...
				<tr>
					<td colspan="2">
						...
						<input type="submit" name="send" value="Update Meat" class="btn-secondary-a">
					</td>
				</tr>
			</table> 
		</form>
		...
		if(isset($_POST['send']))
			{
				...
				if(isset($_FILES['image']['name']))
				{
					...
					//Rename the image
					$image_name="meat--".rand(000,999).'.'.$ext;


					$source_path=$_FILES['image']['tmp_name'];
					$destination_path="../images/meat/".$image_name;
					//Finaly upload the image
					$upload=move_uploaded_file($source_path,$destination_path);
					//Check if the image is uploaded or not
					//If the image is not uploaded then we we stop the process with error message
					if($upload==FALSE){
						$_SESSION['add-meat']="<div class='error'>Failed To Upload Image.</div>";
						header("location:".SITEURL.'admin/update-meat.php');
						die();
					}
					...
					if($current_images!="")
					{
						...
						$remove_path="../images/meat/".$current_images;
				...
				//Update the database
				$sql2="UPDATE tbl_meat SET title='$title',description='$description',price='$price', image_name='$image_name',category_id='$category', featured='$featured', active='$active' WHERE id=$id";
				//Execute the query
				...
				{
					//Category Updated
					$_SESSION['up-meat']="<div class='success'>Meat Successfully Updated</div>";
					//Redirect to manage category page
					header("location:".SITEURL.'admin/manage.meat.php');
				}else
				{
					//Failed to update category
					$_SESSION['up-meat']="<div class='error'>Failed To Update Meat</div>";
					//Redirect to manage category page
					header("location:".SITEURL.'admin/manage.meat.php');
				}
