		...
		<div class="main-content">
			<div class="wrapper">
				...
				<?php  
					...
					{
					echo $_SESSION['no-cat'];// Displaying session message
					unset($_SESSION['no-cat']);//Removing session message
					}
					if(isset($_SESSION['up-cat']))
					{
					echo $_SESSION['up-cat'];// Displaying session message
					unset($_SESSION['up-cat']);//Removing session message
					}
				...
				<br>
				<br>
				<a href="<?php echo SITEURL;?>admin/add-category.php" class="btn-primary" style="text-decoration: none; color: rgb(196, 219, 228);">Add Category</a>
				<br>
				<br>
				<br>
				...
				<table class="tbl_full">
					...
					<?php
						...
						<a href="<?php echo SITEURL;?>admin/delete-category.php?id=<?php echo $id;?>&image_name=<?php echo $image_name;?>" class="btn-secondary-1">Delete Category</a></td>
					</tr>
