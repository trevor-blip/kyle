	...
	<div class="wrapper">
		...
		<form action="" method="POST" enctype="multipart/form-data" class="frm-main">
			<table class="tbl-30">
				...
				<tr>
					<td colspan="2">
						<input type="submit" name="send" value="Add Meat" class="btn-secondary-a">
					</td>
				</tr>
			</table>
		</form>
			...
			if (isset($_FILES['image']['name']))
			{
					...
					if($image_name!="")
					{
						...
						if($upload==FALSE)
						{
							...
							header("location:".SITEURL.'admin/add-meat.php');
							die();
						//Upload the image
						}
					}
				...
				if($res2==true)
				{
				$_SESSION['add-meat']="<div class='success'>Meat Added Succesfully.</div>";
				header("location:".SITEURL.'admin/manage.meat.php');
				}else
				{
					$_SESSION['add-meat']="<div class='error'>Failed To Add Meat.</div>";
				header("location:".SITEURL.'admin/manage.meat.php');
